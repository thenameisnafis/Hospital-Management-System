...
namespace Hospital
{
    public partial class report : Form
    {
        ...
        private void report_Load(object sender, EventArgs e)
        {
            ...
            string connection = "Data Source =USER\\SQLEXPRESS;Initial Catalog=hospital;Integrated Security=true";
            ...
            if (rdr.Read())
            {
                ...
                {
                    label2.Text += "0 EGP."; // Handle the case where the sum is NULL
                }
            }
        ...
        private void dataGridViewSpeciality_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
