...
namespace Hospital
{
    public partial class admin : Form
    {
        ...
        private void DataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (dataGridView1.Columns.Contains("Update"))
            {
                if (e.ColumnIndex == dataGridView1.Columns["Update"].Index && e.RowIndex >= 0)
                {
                    ...
                    string connectionString = "Data Source =USER\\SQLEXPRESS;Initial Catalog=hospital;Integrated Security=true";
        ...
        private async void elapsePanel()
        {
            ...
            {
                panelOnlyDisplay.Height += stepSize; 
        ...
        private void addSubmitbutton_Click(object sender, EventArgs e)
        {
            ...
            string connectString = "Data Source =USER\\SQLEXPRESS;Initial Catalog=hospital;Integrated Security=true";
        ...
        private void panelOnlyDisplay_Paint(object sender, PaintEventArgs e)
        {
